...
namespace Foam
{
    ...
    forDTMGases(makeDTMChemistrySolvers, EulerImplicit, psiReactionThermo); //
    forDTMGases(makeDTMChemistrySolvers, EulerImplicit, rhoReactionThermo); //

    forFTMGases(makeFTMChemistrySolvers, EulerImplicit, psiReactionThermo); //
    forFTMGases(makeFTMChemistrySolvers, EulerImplicit, rhoReactionThermo); //
