...
#include "FTMStandardChemistryModel.H"
...
Foam::FTMStandardChemistryModel<ReactionThermo, ThermoType>::FTMStandardChemistryModel
(
...
:
    ...
    specieThermos_
    (
        dynamic_cast<const FTMMultiComponentMixture<ThermoType>&>
    ...
    dcdt_(nSpecie_)
{
    ...
    Info<< "FTMStandardChemistryModel: Number of species = " << nSpecie_
...
template<class ReactionThermo, class ThermoType>
Foam::FTMStandardChemistryModel<ReactionThermo, ThermoType>::
~FTMStandardChemistryModel()
{}
...
template<class ReactionThermo, class ThermoType>
void Foam::FTMStandardChemistryModel<ReactionThermo, ThermoType>::omega
(
    const scalar p,
    const scalar T,
    const scalarField& c,
...
template<class ReactionThermo, class ThermoType>
Foam::scalar Foam::FTMStandardChemistryModel<ReactionThermo, ThermoType>::omegaI
(
    const label index,
    const scalar p,
    const scalar T,
...
template<class ReactionThermo, class ThermoType>
void Foam::FTMStandardChemistryModel<ReactionThermo, ThermoType>::derivatives
(
    const scalar time,
    const scalarField& c,
    const label li,
...
template<class ReactionThermo, class ThermoType>
void Foam::FTMStandardChemistryModel<ReactionThermo, ThermoType>::jacobian
(
    const scalar t,
    const scalarField& c,
    const label li,
...
Foam::FTMStandardChemistryModel<ReactionThermo, ThermoType>::tc() const
{
...
template<class ReactionThermo, class ThermoType>
Foam::tmp<Foam::volScalarField>
Foam::FTMStandardChemistryModel<ReactionThermo, ThermoType>::Qdot() const
{
...
Foam::FTMStandardChemistryModel<ReactionThermo, ThermoType>::calculateRR
(
    const label ri,
    const label si
) const
...
template<class ReactionThermo, class ThermoType>
void Foam::FTMStandardChemistryModel<ReactionThermo, ThermoType>::calculate()
{
    if (!this->chemistry_)
    {
        return;
...
Foam::scalar Foam::FTMStandardChemistryModel<ReactionThermo, ThermoType>::solve
(
...
template<class ReactionThermo, class ThermoType>
Foam::tmp<Foam::DimensionedField<Foam::scalar, Foam::volMesh>>
Foam::FTMStandardChemistryModel<ReactionThermo, ThermoType>::reactionRate
(
    const label ri
) const
{
