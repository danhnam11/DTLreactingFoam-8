...
Foam::DTMMultiComponentMixture<ThermoType>::readSpeciesData
(
...
template<class ThermoType>
typename Foam::DTMMultiComponentMixture<ThermoType>::speciesCompositionTable
Foam::DTMMultiComponentMixture<ThermoType>::readSpeciesComposition
(
    const dictionary& thermoDict,
...
{
    //Info << "before overwritten operator, executionTime = " << mesh_.time().elapsedCpuTime() << endl;
   ...
   //- Update coefficients for diffusivity mixture
    ...
    //Info << "after updateTrans function, executionTime = " << mesh_.time().elapsedCpuTime() << endl;
...
{
    //Info << "before P.overwritten operator, executionTime = " << mesh_.time().elapsedCpuTime() << endl;
    ...
    //Info << "after P.overwritten operator, executionTime = " << mesh_.time().elapsedCpuTime() << endl;
   ...
   //- Update coefficients for diffusivity mixture
    ...
    //Info << "after P.updateTrans function, executionTime = " << mesh_.time().elapsedCpuTime() << endl;
...
template<class ThermoType>
void Foam::DTMMultiComponentMixture<ThermoType>::read
(
    const dictionary& thermoDict
)
{
