...
#include "DTMStandardChemistryModel.H"
...
Foam::DTMStandardChemistryModel<ReactionThermo, ThermoType>::DTMStandardChemistryModel
(
...
:
    ...
    specieThermos_
    (
        dynamic_cast<const DTMMultiComponentMixture<ThermoType>&>
    ...
    dcdt_(nSpecie_)
{
    ...
    Info<< "DTMStandardChemistryModel: Number of species = " << nSpecie_
...
template<class ReactionThermo, class ThermoType>
Foam::DTMStandardChemistryModel<ReactionThermo, ThermoType>::
~DTMStandardChemistryModel()
{}
...
template<class ReactionThermo, class ThermoType>
void Foam::DTMStandardChemistryModel<ReactionThermo, ThermoType>::omega
(
    const scalar p,
    const scalar T,
    const scalarField& c,
...
template<class ReactionThermo, class ThermoType>
Foam::scalar Foam::DTMStandardChemistryModel<ReactionThermo, ThermoType>::omegaI
(
    const label index,
    const scalar p,
    const scalar T,
...
template<class ReactionThermo, class ThermoType>
void Foam::DTMStandardChemistryModel<ReactionThermo, ThermoType>::derivatives
(
    const scalar time,
    const scalarField& c,
    const label li,
...
template<class ReactionThermo, class ThermoType>
void Foam::DTMStandardChemistryModel<ReactionThermo, ThermoType>::jacobian
(
    const scalar t,
    const scalarField& c,
    const label li,
...
Foam::DTMStandardChemistryModel<ReactionThermo, ThermoType>::tc() const
{
...
template<class ReactionThermo, class ThermoType>
Foam::tmp<Foam::volScalarField>
Foam::DTMStandardChemistryModel<ReactionThermo, ThermoType>::Qdot() const
{
...
Foam::DTMStandardChemistryModel<ReactionThermo, ThermoType>::calculateRR
(
    const label ri,
    const label si
) const
...
template<class ReactionThermo, class ThermoType>
void Foam::DTMStandardChemistryModel<ReactionThermo, ThermoType>::calculate()
{
    if (!this->chemistry_)
    {
        return;
...
Foam::scalar Foam::DTMStandardChemistryModel<ReactionThermo, ThermoType>::solve
(
...
template<class ReactionThermo, class ThermoType>
Foam::tmp<Foam::DimensionedField<Foam::scalar, Foam::volMesh>>
Foam::DTMStandardChemistryModel<ReactionThermo, ThermoType>::reactionRate
(
    const label ri
) const
{
