...
namespace Foam
{
    forDTMGases(makeDTMChemistrySolvers, ode, psiReactionThermo); //
    forDTMGases(makeDTMChemistrySolvers, ode, rhoReactionThermo); //

    forFTMGases(makeFTMChemistrySolvers, ode, psiReactionThermo); //
    forFTMGases(makeFTMChemistrySolvers, ode, rhoReactionThermo); //
